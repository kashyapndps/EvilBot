...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/b1ae67fad00c60d51a5f2.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *FFINDMAX CHATBOT*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/FFINDMAX_CHATBOT?startgroup=true"),
    ],
     [
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *FFINDMAX CHATBOT* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project viacontacting @DM_KASHYAP_BOT \
 Supporting isnt always financial! \
 Those who cannot provide monetary support are welcome to help us develop the bot @FFINDMAXD ."""
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
